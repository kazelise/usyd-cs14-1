  ...
  const text =
    (locale === "zh-CN" || locale === "zh-TW")
      ? {
          ...
          languageCopy: "英文始终启用作为兜底；可按需添加简体中文、繁体中文、日语、韩语或西班牙语。",
          saveLanguages: "保存语言",
      ...
      : {
          ...
          languageCopy: "English is always available as the fallback. Add Simplified Chinese, Traditional Chinese, Japanese, Korean, or Spanish for the locales you support.",
