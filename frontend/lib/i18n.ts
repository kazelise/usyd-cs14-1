...
export const dict = {
  ...
  ar: {
    ...
    trackingStatusTitle: "تتبع الانتباه",
    trackingStatusStarting: "جارٍ تشغيل الكاميرا…",
    trackingStatusTracking: "تم اكتشاف الوجه والعينين",
    trackingStatusWeak: "تتبع ضعيف — الوجه جزئي",
    trackingStatusLost: "فقد التتبع — الوجه غير ظاهر",
